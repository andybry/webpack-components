...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsComponentRenderer = __webpack_require__(158);

	var _componentsComponentRenderer2 = _interopRequireDefault(_componentsComponentRenderer);

	var _dataExampleJson = __webpack_require__(161);

	var _dataExampleJson2 = _interopRequireDefault(_dataExampleJson);

	_react2['default'].render(_react2['default'].createElement(_componentsComponentRenderer2['default'], _dataExampleJson2['default']), document.getElementById('content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ComponentRenderer = (function (_React$Component) {
	  ...
	  function ComponentRenderer() {
	    ...
	    _get(Object.getPrototypeOf(ComponentRenderer.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(ComponentRenderer, [{
	    key: 'render',
	    value: function render() {
	      var Component = textToComponent[this.props.component];
	      var childNodes = this.props.componentChildren.map(function (child, index) {
	        return _react2['default'].createElement(ComponentRenderer, _extends({ key: index }, child));
	      });
